...
public class LeafletManagedBean {
    ...
    private static final Logger logger = Logger.getLogger(LeafletManagedBean.class.getName());
    ...
    public void serverEventHandler(ClientEvent clientEvent) {
        ...
        logger.log(Level.INFO, "parameters passed in from javasscript : " + gson.toJson(LatLong));
